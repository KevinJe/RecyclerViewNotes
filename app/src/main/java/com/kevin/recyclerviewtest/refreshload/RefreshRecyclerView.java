...
import com.kevin.recyclerviewtest.wrap.WrapRecyclerView;
...
//        int distance = currentTopMargin - finalTopMargin;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mRefreshView != null && mRefreshViewHeight <= 0) {
            ...
            if (mRefreshViewHeight > 0) {
                ...
                setRefreshViewMarginTop((int) (-mRefreshViewHeight + dip2px(0.3f)));
                Log.e(TAG, "onLayout: 执行了");
            }
        }
    }
    ...
    private void setRefreshViewMarginTop(int marginTop) {
        ...
        if (marginTop < -mRefreshViewHeight + dip2px(0.3f)) {
            marginTop = (int) (-mRefreshViewHeight + dip2px(0.3f));
        }
        Log.e(TAG, "top" + params.topMargin + "bottom " + params.bottomMargin + "height " + marginTop);
        Log.e(TAG, "dip2px(1)  " + dip2px(0.4f));
...
//        }
        Log.e(TAG, "canScrollUp: " + canScrollVertically(-1));
