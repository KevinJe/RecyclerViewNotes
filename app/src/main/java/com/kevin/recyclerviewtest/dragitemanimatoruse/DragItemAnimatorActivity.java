package com.kevin.recyclerviewtest.dragitemanimatoruse;
...
import com.kevin.recyclerviewtest.adapter.RecyclerViewAdapter;
...
public class DragItemAnimatorActivity extends AppCompatActivity {
    private static final String TAG = "DragItemAnimatorActivit";
...
//                mAdapter.notifyDataSetChanged();
            ...
            public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
             ...
             /*   if (actionState == ItemTouchHelper.ACTION_STATE_IDLE) {
                    Log.e(TAG, "onSelectedChanged: " + "IDLE");
                } else if (actionState == ItemTouchHelper.ACTION_STATE_DRAG) {
                    Log.e(TAG, "onSelectedChanged: " + "DRAG");
                } else if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
                    Log.e(TAG, "onSelectedChanged: " + "SWIPE");
                }*/
            }
            ...
            public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
                ...
                //修复当前一页某个item移除后，下一页复用的item出现空白的情况
                ViewCompat.setTranslationX(viewHolder.itemView, 0);
            }
        });
        // 将RecyclerView与ItemTouchHlper关联起来，让ItemTouchHelper管理RecyclerView的动作
